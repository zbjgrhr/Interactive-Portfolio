...
export const en: ContentShape = {
  ...
  narrative: {
    ...
    "pixel-1": "An idea becomes a specification before it becomes an image.",
    "pixel-2": "Assets become rules; rules become movement.",
    "pixel-3": "A world is complete only when it can be entered, tested, and repaired.",
    "pixel-4": "Pixel World: from imagination to a game you can take with you.",
